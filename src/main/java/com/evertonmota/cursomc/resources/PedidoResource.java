...
import com.evertonmota.cursomc.services.PedidoService;
...
public class PedidoResource {
	...
	//Listar todos os pedido do Cliente.
		...
		@RequestMapping(method=RequestMethod.GET)
			public ResponseEntity <Page<Pedido>> findPage(
				...
				Page <Pedido> listaDePedidos= service.findPage(page, linesPerPage, orderBy, direction);
