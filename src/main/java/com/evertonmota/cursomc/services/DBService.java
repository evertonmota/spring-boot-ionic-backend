...
import com.evertonmota.cursomc.domain.Pagamento;
import com.evertonmota.cursomc.domain.PagamentoComBoleto;
import com.evertonmota.cursomc.domain.PagamentoComCartao;
import com.evertonmota.cursomc.domain.Pedido;
import com.evertonmota.cursomc.domain.Produto;
...
import com.evertonmota.cursomc.repositories.CidadeRepository;
...
import com.evertonmota.cursomc.repositories.EstadoRepository;
...
import com.evertonmota.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat8 = new Categoria(null,"Musicas");
		Categoria cat9 = new Categoria(null,"Livaria");
		...
		Cliente cli1 = new Cliente(null, "Everton mota", "mcostagt@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, encoder.encode("teste"));
		cli1.getTelefones().addAll(Arrays.asList("273633223","938385500"));
		
		Cliente cli2 = new Cliente(null, "Ana Lucia", "mcostagt@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, encoder.encode("teste"));
		cli2.getTelefones().addAll(Arrays.asList("2222-3355","21999556644"));
		cli2.addPerfil(Perfil.ADMIN);
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "APTO 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Av. Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua da Recordação", "Lote 05", "QD - F", "Austin - texas", "38777012", cli2, c2);
